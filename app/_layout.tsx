...
export default function RootLayout() {
  ...
  useEffect(() => {
    initManusRuntime();
    initializeDatabase().catch((error) => console.error("Database init failed:", error));
  }, []);
      ...
      <trpc.Provider client={trpcClient} queryClient={queryClient}>
        <QueryClientProvider client={queryClient}>
          ...
          <Stack screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="qr-result" options={{ presentation: "modal" }} />
            <Stack.Screen name="delivery-confirmation" options={{ presentation: "modal" }} />
            <Stack.Screen name="map-view" options={{ presentation: "modal" }} />
          </Stack>
